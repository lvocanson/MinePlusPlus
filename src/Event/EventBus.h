 ...
 */
template <class Event>
inline void subscribe(Subscriber<Event> subscriber, SubscriptionHandle handle)
{
 ...
 */
template <class Event>
inline SubscriptionHandle subscribe(Subscriber<Event> subscriber)
{
